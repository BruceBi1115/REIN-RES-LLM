...
VALUE_COL="VALUE"
UNIT="views"
DESCRIPTION="This dataset records the bitcoin"
REGION="Bitcoin"

TRAIN_FILE="dataset/FNT-bitcoin/bitcoin_daily_trainset.csv"
VAL_FILE="dataset/FNT-bitcoin/bitcoin_daily_valset.csv"
TEST_FILE="dataset/FNT-bitcoin/bitcoin_daily_testset.csv"
