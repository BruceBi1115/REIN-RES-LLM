...
TRAIN_FILE="dataset/ETTh2/ETTh2_trainset.csv"
VAL_FILE="dataset/ETTh2/ETTh2_valset.csv"
TEST_FILE="dataset/ETTh2/ETTh2_testset.csv"
...
BASE_TASK="TestEtth2withElecpriceNewsfrom2015To2020"
