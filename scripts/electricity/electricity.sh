...
VALUE_COL="OT"
UNIT="$/MWh"
DESC="This dataset records the electricity demand."
REGION="China"

TRAIN_FILE="dataset/electricity/electricity_trainset.csv"
VAL_FILE="dataset/electricity/electricity_valset.csv"
TEST_FILE="dataset/electricity/electricity_testset.csv"

NEWS_PATH="dataset/Summarized_news_2015_2020.json"
NEWS_TEXT_COL="summary_response"
NEWS_TIME_COL="date"
KEYWORD_PATH="keywords/kws_electricity.txt"
...
BASE_TASK="TestElectricityDemandwithElecpriceNewsfrom2015To2020"
