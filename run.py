...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--delta_v3_schema_variant", type=str, default="load", choices=["load", "price"])
    ...
    parser.add_argument("--delta_v3_lambda_ts_cap", type=float, default=0.30)
    parser.add_argument("--delta_v3_lambda_news_cap", type=float, default=0.12)
    parser.add_argument("--delta_v3_lambda_max", type=float, default=0.45)
    parser.add_argument("--delta_v3_shape_gain_cap", type=float, default=0.20)
